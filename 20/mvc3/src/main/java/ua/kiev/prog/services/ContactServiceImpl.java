...
public class ContactServiceImpl implements ContactService {
    ...
    @Transactional  //чтобы выполнить транзакцию. берем транзакцию,
    //трай кетч, если получилось - коммитит, если не получилось - роллбэк
    ...
    @Transactional(readOnly=true) //только на чтение работает
